// REPASAR PARA COMENTAR DETALLADAMENTE PARA QUÉ UTILIZAMOS CADA LÍNEA DE CÓDIGO.
...
class Simon{
    constructor(simonButtons, startButton, round) {
        ...
        this.buttonSounds = [
        new Audio('./sounds/la.wav'),
        new Audio('./sounds/re.wav'),
    ...
    //Devuelve un número aleatorio entre 0 y 3
    getRandomColor() {
    ...
    //Valida si el botón que toca el usuario corresponde a el valor de la secuencia
    ...
    //Verigica que no haya acabado el juego
    isGameOver() {
